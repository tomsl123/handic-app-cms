...
export interface ApiAccessibilityFeatureAccessibilityFeature
  extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    accessibility_need: Schema.Attribute.Relation<
      'manyToOne',
...
export interface ApiCompanionCompanion extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    accompanying: Schema.Attribute.Relation<
      'manyToOne',
...
export interface ApiDisabilityCardDisabilityCard
  ...
  attributes: {
    ...
    createdBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
    expiry: Schema.Attribute.Date & Schema.Attribute.Required;
...
export interface PluginUsersPermissionsUser
  ...
  attributes: {
    ...
    createdBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
    disability_card: Schema.Attribute.Relation<
      'oneToOne',
      'api::disability-card.disability-card'
    >;
    email: Schema.Attribute.Email &
